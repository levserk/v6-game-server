...
GameManager.prototype.onTimeout = function(room, user){
    ...
    var nextPlayer, turn, game = room.game, isGameEnd;
    if (typeof this.engine.onTimeout == 'function'){
        turn = this.engine.onTimeout(room, user);
    } else {
        turn = this.defaultEngine.onTimeout(room, user);
    }
