...
GameManager.prototype.onUserTurn = function(room, user, turn){
    ...
    if (!isGameEnd && (nextPlayer != game.current || room.timeMode == 'reset_every_turn')) {
        if (room.timeout && room.timeMode == 'reset_every_turn') clearTimeout(room.timeout);
