...
GameManager.prototype.onUserTurn = function(room, user, turn){
    ...
    if (turn.action == 'timeout') turn.action = undefined;
    turn.userTurnTime = undefined;
    turn.nextPlayer = undefined;
    ...
    if (room.userTurnTime) {
        userTurn.userTurnTime = room.userTurnTime
    }
