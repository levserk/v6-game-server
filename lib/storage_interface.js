...
StorageInterface.prototype.getHistory = function(userId, mode, count, offset, filter){
    ...
    return this.mongo.loadHistory(userId, mode, count, offset, filter);
};
...
StorageInterface.prototype.getRatings = function(userId, params){
    ...
    return this.mongo.loadRating(userId, params.mode, count, offset, params.column, params.order, params.filter);
};